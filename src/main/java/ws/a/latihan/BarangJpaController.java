...
import ws.a.latihan.exceptions.NonexistentEntityException;
import ws.a.latihan.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.a_latihan_jar_0.0.1-SNAPSHOTPU");
